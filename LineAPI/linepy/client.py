...
class LINE(Auth, Models, Talk, Square, Call, Timeline, Shop):
    ...
    def __init__(self, idOrAuthToken=None, passwd=None, certificate=None, systemName=None, appName="DESKTOPWIN\t8.3.2\tArsybai\t8.3.2", showQr=False, keepLoggedIn=True):
